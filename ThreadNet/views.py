...
from .forms import TweetForm, UserRegistratioForm
...
def tweet_search(request):
    query = request.GET.get('q','').strip()  # Capture query and remove whitespace
    print("Search Query: ", query)   # ✅ Debug the query
